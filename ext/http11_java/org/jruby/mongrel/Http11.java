...
public class Http11 extends RubyObject {
    ...
    private static final String MODULE_NAME = "EventMachine";
    private static final String PARSER_NAME = "HttpClientParser";
    private static final String PARSER_ERROR_NAME = "HttpClientParserError";
    ...
    public static void createHttp11(Ruby runtime) {
        RubyModule mEventMachine = runtime.getOrCreateModule(MODULE_NAME);
        mEventMachine.defineClassUnder(PARSER_ERROR_NAME,runtime.getClass("IOError"),runtime.getClass("IOError").getAllocator());

        CallbackFactory cf = runtime.callbackFactory(Http11.class);

        RubyClass cHttpParser = mEventMachine.defineClassUnder(PARSER_NAME,runtime.getObject(),ALLOCATOR);
    ...
    public Http11(Ruby runtime, RubyClass clazz) {
        ...
        this.eHttpParserError = (RubyClass)runtime.getModule(MODULE_NAME)
                                                  .getConstantAt(PARSER_ERROR_NAME);
